        ...
        <el-form ref="form" class="form" :inline="true" :model="form">
            <div>
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="维护超期提醒时间" label-position="top" prop="enterpriseUsername" :rules="$validate({required:true})" >
                           <el-date-picker
                                style="width:100%;"
                                v-model="form.enterpriseUsername"
                                type="date"
                                placeholder="选择日期">
                            </el-date-picker>
                        </el-form-item>
                    ...
                    <el-col :span="8">
                        <el-form-item label="综合检测提醒时间" label-position="top" prop="enterpriseUsername" :rules="$validate({required:true})" >
                           <el-date-picker
                                style="width:100%;"
                                v-model="form.enterpriseUsername"
                                type="date"
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="拥有车辆数" label-position="top" prop="enterpriseRegisteredCapital">
                            <el-input type="number" v-model="form.enterpriseRegisteredCapital" />
                        </el-form-item>
                    </el-col>
                    <!-- <el-col :span="8">
