...
<template>
    <div class="certificateProvide" id="certificateProvide">
        ...
        <breadcrumb>
            ...
            <label for="">订单号:</label>
            <el-input style="width:160px;" class="search-text" v-model="searchKey" placeholder="请输入" clearable></el-input>
            <label for="">状态:</label>
            <el-select class="w120_input" clearable v-model="chargeStatus" placeholder="请选择">
                <el-option
                v-for="item in [{value:'ToAudit',label:'待审核'},{value:'ToStorage',label:'待入库'},{value:'finished',label:'已完结'}]"
                :key="item.value"
                :label="item.label"
                clearable
                :value="item.value">
            ...
            <!-- </div> -->
            <div class="dlb fr">
                <el-button class="fr mt17" icon="el-icon-plus" type="primary" :disabled="!$checkAuth('rfid:purchase:add')"  @click="showAlert=true">新增采购</el-button>
                <el-button class="fr mt17"  type="primary" :disabled="!$checkAuth('rfid:purchase:export')" @click="exportEXC">导出</el-button>
                <!-- <el-dropdown
        ...
        <modal
            ...
            <div class="detail_box clearfix" style="padding-bottom:0;">
                ...
                <div class="clearfix">
                    ...
                    <div class="detail_item">
                        <label for="">审核人：</label>
                        <span>{{detailObj.auditPerson}}</span>
                    </div>
                    <div class="detail_item">
                        <label for="">采购说明：</label>
                        <span>{{detailObj.orderRemark}}</span>
                    ...
                    <div class="detail_item">
                        ...
                        <span>{{detailObj.auditRemark}}</span>
                    </div>
                    <div class="detail_item detail_item2">
                        <label for="">采购审批<br>通过截图：</label>
                        <span>
                            <img :src="detailObj.approvalUrl1" width="88" height="88" v-if="detailObj.approvalUrl1" class="imgBoder" @click="$lookImg(detailObj.approvalUrl1)">
                            <img :src="detailObj.approvalUrl2" width="88" height="88" v-if="detailObj.approvalUrl2" class="imgBoder" @click="$lookImg(detailObj.approvalUrl2)">
                            <img :src="detailObj.approvalUrl3" width="88" height="88" v-if="detailObj.approvalUrl3" class="imgBoder" @click="$lookImg(detailObj.approvalUrl3)">
