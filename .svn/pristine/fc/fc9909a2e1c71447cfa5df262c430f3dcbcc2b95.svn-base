<template>
    <div class="city-open">
        <breadcrumb>
            ...
            filterable />
            <label>状态：</label>
            <el-select class="w120_input" filterable clearable v-model="status" placeholder="请选择">
                <el-option
            ...
            <label>城市名称：</label>
            <el-input style="width:240px;" clearable v-model="cityName" placeholder="请输入"></el-input>
