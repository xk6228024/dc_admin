...
<template>
    <div class="owerDataStatistics">
        ...
        <div class="right_div" v-loading="loading">
            ...
            <div class="right_header" >车主数据统计
                <!-- <span v-if="type==1">车主总计: <i>{{allCount}}</i></span> -->
            </div>
        ...
        <div class="bottom_div">
            ...
            <el-radio v-model="radio" label="type">按车主类型统计</el-radio>
...
export default {
    ...
    created () {
        this.getData()
        this.$post('statistics/owner/all').then(res => {
            // console.log(res)
    ...
    methods: {
        ...
        getData () {
            this.loading = true
            this.$post(`/statistics/owner/${this.radio}`).then(res => {
                this.loading = false
