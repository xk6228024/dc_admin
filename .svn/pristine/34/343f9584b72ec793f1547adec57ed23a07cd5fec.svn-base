<template>
    <el-dialog width="650px" :title="!dataForm.carBrandId ? '新增一级品牌' : '修改一级品牌'" :close-on-click-modal="false" :visible.sync="visible" class="carbrandAddOrUpdate">
        <el-form :model="dataForm" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
            <el-form-item label="品牌名称" prop="carBrandName" :rules="$validate({required:true,max:60})">
