<!-- 企业数据详情-不可编辑 -->
<template>
    <div class="inspectionOfEnterpriseDetail detailPage" id="inspectionOfEnterpriseDetail">
        ...
        <div class="detail_content" v-loading="loading">
            <div class="detail_model" v-show="!edit">
                ...
                <div class="clearfix">
                    ...
                    <div class="detail_item">
                        ...
                        <span class="value">{{detailData.enterpriseJcGradename}}</span>
                    </div>
                    <div class="detail_item">
                        ...
                        <!-- <span class="value">
                            {{detailData.enterpriseOperatingAddress}}
                        </span> -->
                    </div>
                    <div class="detail_item">
                        <span class="label">检测范围：</span>
                        <span class="value">{{detailData.xxxxxxxxxxxxx}}</span>
                    </div>
                    <div class="detail_item">
                        <span class="label">限制范围：</span>
                        <span class="value">{{detailData.xxxxxxxxxxxxx}}</span>
                    </div>
                    <!-- <div class="detail_item">
                    ...
                    <div class="detail_item">
                        ...
                        <span class="value">{{detailData.enterpriseCertificateE|filterTime('yyyy-mm-dd')}}</span>
                    </div>
                    <div class="detail_item">
                ...
                <div class="second clearfix">
                    <div class="clearfix">
                        <div class="detail_item">
                            ...
                            <span class="value" v-if="detailData.enterpriseAddrX">{{detailData.enterpriseAddrX}} ; {{detailData.enterpriseAddrY}}</span>
                        ...
                        <div class="detail_item" style="width:100%;">
                            ...
                            <span class="value">{{detailData.vehicleBrandName}}</span>
                        </div>
                        <div class="detail_item">
            ...
            <div class="detail_model" style="border:none;" v-show="!edit">
                ...
                <div class="clearfix">
                    <div class="detail_item">
                        <span class="label">检测企业停车场面积(m²)：</span>
...
export default {
    ...
    methods: {
        ...
        getData () {
            ...
            // }
            this.loading = true
            this.$post('insEnt/detail/' + this.enterpriseId)
                .then(res => {
                    if (res && res.code === 0) {
                        // res.data.exportInsEntInfo
                        for (let item in res.data.exportInsEntInfo) {
                            // console.log(item)
                            res.data[item] = res.data.exportInsEntInfo[item]
                        }
                        for (let item in res.data.insEntDetail) {
                            // console.log(item)
                            res.data[item] = res.data.insEntDetail[item]
                        }
                        for (let item in res.data.jcOtherInfo) {
                            // console.log(item)
                            res.data[item] = res.data.jcOtherInfo[item]
                        }
                        // 图片格式转换
                        ...
                        if (res.data.enterpriseImagesUrl && typeof res.data.enterpriseImagesUrl === 'string') {
                            res.data.enterpriseStoresImages = res.data.enterpriseImagesUrl.split(',')
                        } else if (Object.prototype.toString.call(res.data.enterpriseImagesUrl) !== '[object Array]') {
                        ...
                        // 经纬度转换
                        res.data.enterpriseAddrX = res.data.enterpriseAddrX ? res.data.enterpriseAddrX - 0 : ''
                        res.data.enterpriseAddrY = res.data.enterpriseAddrY ? res.data.enterpriseAddrY - 0 : ''
                        // 日期转换
        ...
        close () {
            if (this.isEdit && this.edit) {
                ...
                this.$store.dispatch('closePage', {
                    nextPath: '/inspectionOfEnterpriseArchives',
                    refresh: 'inspectionOfEnterpriseArchives'
                })
            }
        }
    },
