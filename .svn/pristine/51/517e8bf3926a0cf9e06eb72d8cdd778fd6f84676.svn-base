...
<template>
    <div class="certificateProvide" id="certificateProvide">
        <search v-model='searchValue' :options='searchOption' @search='search()'>
            <el-button type="primary" size="mini" icon="el-icon-plus" @click="showAlert=true">新建领取</el-button>
        </search>
        <div class="table">
            <el-table
                border
                ...
                label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button @click.stop="" type="text" size="small">删除</el-button>
        ...
        <modal
            ...
            <div class="alertInner">
                <el-form :model="form" ref="form"  label-width="100px">
                    <el-form-item label="所属城市：" prop="enterpriseCertificateS" :rules="$validate({required:true,msg:'请输入'})">
                    ...
                    <el-form-item label="企业名单：" prop="enterpriseCertificateS" :rules="$validate({required:true,msg:'请输入'})">
                        <el-select size="mini" v-model="form.enterpriseCertificateS" placeholder="请选择" clearable class="wp100">
                            <el-option
                            v-for="child in []"
                            :key="child.regionId"
                    ...
                    <el-form-item label="领取数量：" prop="enterpriseCertificateS" :rules="$validate({required:true,msg:'请输入'})">
                        <el-input
                            clearable
                            maxlength="12"
                            size="mini"
                    ...
                    <el-form-item label="领取时间：" prop="enterpriseCertificateS" :rules="$validate({required:true,msg:'请输入'})">
                        <el-date-picker
                            v-model="form.enterpriseCertificateS"
                            type="date"
                            clearable
                    ...
                    <el-form-item label="财务人员：" prop="enterpriseCertificateS" :rules="$validate({required:true,msg:'请输入'})">
                        <el-select size="mini" v-model="form.enterpriseCertificateS" placeholder="请选择" clearable class="wp100">
                            <el-option
                            v-for="child in []"
                            :key="child.regionId"
