...
<template>
    <div class="purchaseExport" id="purchaseExport">
        <breadcrumb>
            <div class="dlb">
                <label for="">企业名称:</label>
                <el-input style="width:160px;" class="search-text" v-model="enterpriseNamekey" placeholder="请输入"></el-input>
            ...
            <div class="dlb fr">
                ...
                <el-button class="fr mt17" type="primary" @click="showAlert = true">绑定企业</el-button>
                <!-- <el-dropdown
        ...
        <modal
            ...
            <div class="alertInner">
                <el-form :model="form" ref="form"  label-width="100px">
                    <el-form-item label="绑定企业：" prop="entName" :rules="$validate({required:true,msg:'请选择企业'})">
                        <el-select
                            style="width:100%;"
                    ...
                    <el-form-item label="选择商品：" prop="enterpriseCertificateNum2" :rules="$validate({required:true})">
                        <el-select style="width:100%;" v-model.trim="form.enterpriseCertificateNum2">
                            <el-option value='1' label="RFID塑料袋"></el-option>
                            <el-option value='2' label="RFID塑料袋"></el-option>
                            <el-option value='3' label="RFID塑料袋"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="商品数量：" prop="enterpriseCertificateNum" :rules="$validate({required:true,msg:'',type:'>0'})">
                        <el-input
                            clearable
                            maxlength="12"
                            class=""
...
export default {
    ...
    data () {
        return {
            ...
            searchLoading: false,
            form: {
                enterpriseCertificateNum: '999',
                enterpriseCertificateNum2: 1,
                entName: '深圳万顺汽车维修厂',
                enterpriseId: '',
                enterpriseCertificateS: 'NO.4521238891231',
                enterpriseCertificateE: 'NO.4521238891219'
            },
            allCityList: [],
            multipleSelection: [],
            chargeStatusList: [
