<!-- 权限管理 -->
<template>
    <div class="operatingVehicleArchives">
        <breadcrumb>
        <label for="">关键词:</label>
        <el-input style="width:160px;" class="search-text" clearable v-model="searchText" placeholder="车牌号码/VIN码"></el-input>
        <el-button type="primary" class="search" @click="pageNum=1;pageSize=10;getList()">查询</el-button>
            <!-- <label for="">省份:</label>
...
export default {
    ...
    methods: {
        ...
        goDetail (id) {
            this.$router.push(`/operatingVehicleDetail?id=${id}`)
        },
        search () {},
        getList () {
            this.loading = true
            ...
            this.$post(`vehicle/y/list?size=${this.pageSize}&page=${this.pageNum}`, {
                regionIds: regionIds,
