<!-- 数据统计 -->
<template>
    <div class="enterpriseDataStatistics">
        ...
        <div class="right_div" v-loading="loading">
            ...
            <div class="right_header" >维修企业数据统计
...
export default {
    ...
    created () {
        this.getData()
        this.$post('statistics/enterprise/all').then(res => {
            // console.log(res)
    ...
    methods: {
        ...
        getData () {
            this.loading = true
            this.$post(`/statistics/enterprise/${this.radio}`).then(res => {
                this.loading = false
