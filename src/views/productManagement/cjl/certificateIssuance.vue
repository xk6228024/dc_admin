    ...
    <div class="certificateProvide" id="certificateProvide">
        ...
        <!-- <breadcrumb>
            <div class="dlb">
                ...
                <el-select class="" clearable v-model="regionId" placeholder="请选择">
                    <el-option
            ...
            <el-table
                ...
                label="操作">
                    <template slot-scope="scope">
                        <el-button @click="showAlert=true;editId=scope.row.enterpriseId" type="text" size="small">发放合格证</el-button>
