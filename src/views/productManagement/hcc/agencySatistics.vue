    ...
    <div class="agencySatistics">
        ...
        <div class="table">
            ...
            <div class="pagination clearfix">
                ...
                <p class="bottom-data fl" style="">本期数据&nbsp;&nbsp;&nbsp;总代理数量：{{sum1}}家&nbsp;&nbsp;&nbsp;总交易次数：{{sum2}}次&nbsp;&nbsp;&nbsp;总交易额：{{sum3}}元</p>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getDataList () {
            ...
            this.$post('agentbusiness/find?page=' + this.pageNum + '&size=' + this.pageSize, obj)
                .then(res => {
                    if (res && res.code === 0) {
                        this.tableData = this.$setNum(res.data.agentBusinessList, this.pageNum, this.pageSize)
                        this.sum1 = res.data.agentStasticCount
                        // console.log(res.data.totalConsumeCount)
                        this.sum2 = res.data.agentBusinessStasticCount
                        this.sum3 = res.data.agentBusinessStasticMoney
