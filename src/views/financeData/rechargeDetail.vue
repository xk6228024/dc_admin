...
<template>
    <div class="rechargeDetail">
        <breadcrumb :breadList="['财务管理', '企业充值开票']">
            ...
            <el-select class="w100_input" v-model="value" placeholder="请选择">
                <el-option
            ...
            <div class="alertInner">
                <table class="myTable">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="tal fontColor">维修企业</td>
                    </tr>
                    <tr class="blueTilte">
                    ...
                    <tr>
                        ...
                        <td class="tal fontColor" width="270">维修企业</td>
                        <td class="tar" width="150">充值方式：</td>
                        <td class="tal fontColor">维修企业</td>
                    </tr>
                    <tr>
